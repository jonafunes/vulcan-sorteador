  ...
  return (
    <div className="container mx-auto px-4 py-8 min-h-screen flex flex-col justify-center">
      <div className="flex flex-col items-center mb-12">
        <Trophy className="h-16 w-16 text-yellow-400 mb-4 drop-shadow-lg" />
        <h1 className="text-4xl font-bold mb-2 text-center text-white drop-shadow-lg">Torneo de FIFA</h1>
        <p className="text-white/80 text-center drop-shadow">Selecciona el tipo de torneo que deseas crear</p>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <Card 
          className="cursor-pointer hover:shadow-2xl hover:border-white/50 transition-all duration-200 bg-white/90 backdrop-blur-md"
